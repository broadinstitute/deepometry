...
def _parse_cif(pathname, size, channels):
    ...
    # An overflow error occurs in Javabridge when reading image 190663 and above.
...
def _pad(image, pad_width):
    ...
    #   - Sample all 4 corners, discard outliers (possible artifacts in corner),
    #   - Sample masked pixels,
    #   - Assuming a bimodal intensity distribution, sample the mean and standard deviation from the background peak.
    sample = image[-10:, -10:]
